...
panel_menu() {
    while true; do
        ...
        echo -e "  ${GRAY}│${NC} ${PURPLE}[3]${NC} vPanel               ${GRAY}│${NC}                          │${NC}"
        echo -e "  ${GRAY}│${NC} ${RED}[0]${NC} Back                 ${GRAY}│${NC}                          │${NC}"
        echo -e "  ${GRAY}└──────────────────────────┴──────────────────────────┘${NC}"
        echo
        echo -ne "  ${CYAN}➜${NC} ${WHITE}Select Module [0-3]:${NC} "
        read -r choice
        ...
        case "$choice" in
            ...
            3) echo -e "  ${CYAN}➜ Executing vPanel installer...${NC}"; run_panel "panel/vpanel/run.sh" ;;
